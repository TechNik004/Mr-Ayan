...
API_ID = int(environ.get('API_ID', '21925460'))
API_HASH = environ.get('API_HASH', '3f02710547a070e8da98bd401627a3d6')
...
# ============================
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1912687309 6667067260').split()] # Replace with the actual admin ID(s) to add
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1003143473987').split()]  # Channel id for auto indexing (make sure bot is admin)
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1003158679239'))  # Log channel id (make sure bot is admin)
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1003158679239'))  # Bin channel id (make sure bot is admin)
...
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1003158679239'))  # Premium logs channel id
auth_channel = environ.get('AUTH_CHANNEL', '-1003009517198')  # Channel/Group ID for force sub (make sure bot is admin)
...
AUTH_CHANNEL = [int(fch) if id_pattern.search(fch) else fch for fch in environ.get('AUTH_CHANNEL', '-1003009517198').split()]
...
OWNER_UPI_ID = environ.get('OWNER_UPI_ID', 'mohd1111111111@fam')
...
HOW_TO_VERIFY = environ.get('HOW_TO_VERIFY', 'https://t.me/PublicCinima/26')  # How to open tutorial link for verification
...
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/PublicCinima/26')  # Tutorial video link for opening shortlink website
...
# User Configuration
# ============================
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '1912687309 6667067260').split()]
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/ayan771')  # Support group link (make sure bot is admin)
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1003143473987')).split()]
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
BIND_ADRESS = str(getenv('WEB_SERVER_BIND_ADDRESS', 'mr-ayan-6opw.onrender.com'))
...
SESSION_NAME = str(environ.get('SESSION_NAME', 'mrayanbot'))
MULTI_CLIENT = False
name = str(environ.get('name', 'mrayan'))
